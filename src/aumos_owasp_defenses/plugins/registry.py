"""Plugin registry for aumos-owasp-defenses.
...
"aumos_owasp_defenses.plugins" group.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "aumos_owasp_defenses.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("aumos_owasp_defenses.plugins")
        """
