# Contributing to aumos-owasp-defenses

Thank you for contributing to aumos-owasp-defenses, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/aumos-owasp-defenses.git
cd aumos-owasp-defenses
pip install -e ".[dev]"
```
