"""Comparison visualiser for aumos-owasp-defenses benchmark results."""
...
def main() -> None:
    ...
    print(f"\n{'=' * 80}")
    print("  aumos-owasp-defenses Benchmark Results")
    print(f"{'=' * 80}")
    ...
    print("    python benchmarks/bench_defense_throughput.py")
    print("    python benchmarks/bench_pattern_latency.py")
